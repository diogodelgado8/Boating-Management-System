...
try:
    ...
    # Making query
    sql= 'INSERT INTO authorised(cni, start_date, end_date, boat_country, sailor)\
                VALUES(%(cni)s, %(start_date)s, %(end_date)s, %(country)s, %(sailor)s);'

    data=({'cni': cni, 'start_date': start_date, 'end_date': end_date, 'country': country, 'sailor': sailor})
    ...
    print('<h1>Sailor successfully authorised.</h1>')
